...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new finnhub.SECSentimentAnalysis();
  });
  ...
  describe('SECSentimentAnalysis', function() {
    it('should create an instance of SECSentimentAnalysis', function() {
      // uncomment below and update the code to test SECSentimentAnalysis
      //var instane = new finnhub.SECSentimentAnalysis();
      //expect(instance).to.be.a(finnhub.SECSentimentAnalysis);
    });
    ...
    it('should have the property accessNumber (base name: "accessNumber")', function() {
      ...
      //var instance = new finnhub.SECSentimentAnalysis();
