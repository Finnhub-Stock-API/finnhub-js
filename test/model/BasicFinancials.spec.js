...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new finnhub.BasicFinancials();
  });
  ...
  describe('BasicFinancials', function() {
    it('should create an instance of BasicFinancials', function() {
      // uncomment below and update the code to test BasicFinancials
      //var instane = new finnhub.BasicFinancials();
      //expect(instance).to.be.a(finnhub.BasicFinancials);
    });
