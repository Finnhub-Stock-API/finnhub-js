...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new finnhub.MarketStatus();
  });
  ...
  describe('MarketStatus', function() {
    it('should create an instance of MarketStatus', function() {
      ...
      //var instane = new finnhub.MarketStatus();
      //expect(instance).to.be.a(finnhub.MarketStatus);
    });
    ...
    it('should have the property exchange (base name: "exchange")', function() {
      ...
      //var instance = new finnhub.MarketStatus();
