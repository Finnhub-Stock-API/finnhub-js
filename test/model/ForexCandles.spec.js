...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new finnhub.ForexCandles();
  });
  ...
  describe('ForexCandles', function() {
    it('should create an instance of ForexCandles', function() {
      // uncomment below and update the code to test ForexCandles
      //var instane = new finnhub.ForexCandles();
      //expect(instance).to.be.a(finnhub.ForexCandles);
    });
