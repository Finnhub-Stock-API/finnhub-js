...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new finnhub.ETFsHoldings();
  });
  ...
  describe('ETFsHoldings', function() {
    it('should create an instance of ETFsHoldings', function() {
      // uncomment below and update the code to test ETFsHoldings
      //var instane = new finnhub.ETFsHoldings();
      //expect(instance).to.be.a(finnhub.ETFsHoldings);
    });
