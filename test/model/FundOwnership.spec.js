...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new finnhub.FundOwnership();
  });
  ...
  describe('FundOwnership', function() {
    it('should create an instance of FundOwnership', function() {
      // uncomment below and update the code to test FundOwnership
      //var instane = new finnhub.FundOwnership();
      //expect(instance).to.be.a(finnhub.FundOwnership);
    });
