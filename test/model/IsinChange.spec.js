...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new finnhub.IsinChange();
  });
  ...
  describe('IsinChange', function() {
    it('should create an instance of IsinChange', function() {
      // uncomment below and update the code to test IsinChange
      //var instane = new finnhub.IsinChange();
      //expect(instance).to.be.a(finnhub.IsinChange);
    });
    ...
    it('should have the property fromDate (base name: "fromDate")', function() {
      ...
      //var instance = new finnhub.IsinChange();
