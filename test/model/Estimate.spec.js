...
(function(root, factory) {
  ...
  describe('Estimate', function() {
    it('should create an instance of Estimate', function() {
      // uncomment below and update the code to test Estimate
      //var instane = new finnhub.Estimate();
      //expect(instance).to.be.a(finnhub.Estimate);
    });
