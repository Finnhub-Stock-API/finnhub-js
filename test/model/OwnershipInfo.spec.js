...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new finnhub.OwnershipInfo();
  });
  ...
  describe('OwnershipInfo', function() {
    it('should create an instance of OwnershipInfo', function() {
      // uncomment below and update the code to test OwnershipInfo
      //var instane = new finnhub.OwnershipInfo();
      //expect(instance).to.be.a(finnhub.OwnershipInfo);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new finnhub.OwnershipInfo();
