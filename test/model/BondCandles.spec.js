...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new finnhub.BondCandles();
  });
  ...
  describe('BondCandles', function() {
    it('should create an instance of BondCandles', function() {
      // uncomment below and update the code to test BondCandles
      //var instane = new finnhub.BondCandles();
      //expect(instance).to.be.a(finnhub.BondCandles);
    });

    it('should have the property c (base name: "c")', function() {
      // uncomment below and update the code to test the property c
      //var instance = new finnhub.BondCandles();
