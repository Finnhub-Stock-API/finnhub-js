...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new finnhub.EmployeeCount();
  });
  ...
  describe('EmployeeCount', function() {
    it('should create an instance of EmployeeCount', function() {
      ...
      //var instane = new finnhub.EmployeeCount();
      //expect(instance).to.be.a(finnhub.EmployeeCount);
    });
    ...
    it('should have the property atDate (base name: "atDate")', function() {
      ...
      //var instance = new finnhub.EmployeeCount();
