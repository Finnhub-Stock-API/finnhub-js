...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new finnhub.Forexrates();
  });
  ...
  describe('Forexrates', function() {
    it('should create an instance of Forexrates', function() {
      // uncomment below and update the code to test Forexrates
      //var instane = new finnhub.Forexrates();
      //expect(instance).to.be.a(finnhub.Forexrates);
    });
