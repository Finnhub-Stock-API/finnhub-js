...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new finnhub.DocumentResponse();
  });
  ...
  describe('DocumentResponse', function() {
    it('should create an instance of DocumentResponse', function() {
      ...
      //var instane = new finnhub.DocumentResponse();
      //expect(instance).to.be.a(finnhub.DocumentResponse);
    });
    ...
    it('should have the property documentId (base name: "documentId")', function() {
      ...
      //var instance = new finnhub.DocumentResponse();
