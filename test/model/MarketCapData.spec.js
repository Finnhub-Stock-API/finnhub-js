...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new finnhub.MarketCapData();
  });
  ...
  describe('MarketCapData', function() {
    it('should create an instance of MarketCapData', function() {
      // uncomment below and update the code to test MarketCapData
      //var instane = new finnhub.MarketCapData();
      //expect(instance).to.be.a(finnhub.MarketCapData);
    });
    ...
    it('should have the property atDate (base name: "atDate")', function() {
      ...
      //var instance = new finnhub.MarketCapData();
