...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new finnhub.HistoricalNBBO();
  });
  ...
  describe('HistoricalNBBO', function() {
    it('should create an instance of HistoricalNBBO', function() {
      // uncomment below and update the code to test HistoricalNBBO
      //var instane = new finnhub.HistoricalNBBO();
      //expect(instance).to.be.a(finnhub.HistoricalNBBO);
    });

    it('should have the property s (base name: "s")', function() {
      // uncomment below and update the code to test the property s
      //var instance = new finnhub.HistoricalNBBO();
    ...
    it('should have the property ax (base name: "ax")', function() {
      // uncomment below and update the code to test the property ax
      //var instance = new finnhub.HistoricalNBBO();
      //expect(instance).to.be();
    });
    ...
    it('should have the property bx (base name: "bx")', function() {
      // uncomment below and update the code to test the property bx
      //var instance = new finnhub.HistoricalNBBO();
      //expect(instance).to.be();
    });
