...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new finnhub.SupportResistance();
  });
  ...
  describe('SupportResistance', function() {
    it('should create an instance of SupportResistance', function() {
      // uncomment below and update the code to test SupportResistance
      //var instane = new finnhub.SupportResistance();
      //expect(instance).to.be.a(finnhub.SupportResistance);
    });
