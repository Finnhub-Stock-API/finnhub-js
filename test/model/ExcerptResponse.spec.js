...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new finnhub.ExcerptResponse();
  });
  ...
  describe('ExcerptResponse', function() {
    it('should create an instance of ExcerptResponse', function() {
      // uncomment below and update the code to test ExcerptResponse
      //var instane = new finnhub.ExcerptResponse();
      //expect(instance).to.be.a(finnhub.ExcerptResponse);
    });

    it('should have the property content (base name: "content")', function() {
      // uncomment below and update the code to test the property content
      //var instance = new finnhub.ExcerptResponse();
      //expect(instance).to.be();
    });

    it('should have the property snippetId (base name: "snippetId")', function() {
