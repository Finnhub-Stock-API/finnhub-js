...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new finnhub.SearchResponse();
  });
  ...
  describe('SearchResponse', function() {
    it('should create an instance of SearchResponse', function() {
      ...
      //var instane = new finnhub.SearchResponse();
      //expect(instance).to.be.a(finnhub.SearchResponse);
    });

    it('should have the property count (base name: "count")', function() {
      // uncomment below and update the code to test the property count
      //var instance = new finnhub.SearchResponse();
