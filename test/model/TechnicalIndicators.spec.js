...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new finnhub.TechnicalIndicators();
  });
  ...
  describe('TechnicalIndicators', function() {
    it('should create an instance of TechnicalIndicators', function() {
      // uncomment below and update the code to test TechnicalIndicators
      //var instane = new finnhub.TechnicalIndicators();
      //expect(instance).to.be.a(finnhub.TechnicalIndicators);
    });
