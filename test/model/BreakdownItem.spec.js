...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new finnhub.BreakdownItem();
  });
  ...
  describe('BreakdownItem', function() {
    it('should create an instance of BreakdownItem', function() {
      // uncomment below and update the code to test BreakdownItem
      //var instane = new finnhub.BreakdownItem();
      //expect(instance).to.be.a(finnhub.BreakdownItem);
    });
    ...
    it('should have the property accessNumber (base name: "accessNumber")', function() {
      ...
      //var instance = new finnhub.BreakdownItem();
