...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new finnhub.EarningsEstimatesInfo();
  });
  ...
  describe('EarningsEstimatesInfo', function() {
    it('should create an instance of EarningsEstimatesInfo', function() {
      // uncomment below and update the code to test EarningsEstimatesInfo
      //var instane = new finnhub.EarningsEstimatesInfo();
      //expect(instance).to.be.a(finnhub.EarningsEstimatesInfo);
    });
    ...
    it('should have the property epsAvg (base name: "epsAvg")', function() {
      ...
      //var instance = new finnhub.EarningsEstimatesInfo();
