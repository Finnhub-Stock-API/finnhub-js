...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new finnhub.RecommendationTrends();
  });
  ...
  describe('RecommendationTrends', function() {
    it('should create an instance of RecommendationTrends', function() {
      // uncomment below and update the code to test RecommendationTrends
      //var instane = new finnhub.RecommendationTrends();
      //expect(instance).to.be.a(finnhub.RecommendationTrends);
    });
