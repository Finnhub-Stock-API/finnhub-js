...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new finnhub.InvestorsOwnership();
  });
  ...
  describe('InvestorsOwnership', function() {
    it('should create an instance of InvestorsOwnership', function() {
      // uncomment below and update the code to test InvestorsOwnership
      //var instane = new finnhub.InvestorsOwnership();
      //expect(instance).to.be.a(finnhub.InvestorsOwnership);
    });
