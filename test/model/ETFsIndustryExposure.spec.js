...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new finnhub.ETFsIndustryExposure();
  });
  ...
  describe('ETFsIndustryExposure', function() {
    it('should create an instance of ETFsIndustryExposure', function() {
      // uncomment below and update the code to test ETFsIndustryExposure
      //var instane = new finnhub.ETFsIndustryExposure();
      //expect(instance).to.be.a(finnhub.ETFsIndustryExposure);
    });
