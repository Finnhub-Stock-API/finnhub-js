...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new finnhub.SymbolChange();
  });
  ...
  describe('SymbolChange', function() {
    it('should create an instance of SymbolChange', function() {
      // uncomment below and update the code to test SymbolChange
      //var instane = new finnhub.SymbolChange();
      //expect(instance).to.be.a(finnhub.SymbolChange);
    });
    ...
    it('should have the property fromDate (base name: "fromDate")', function() {
      ...
      //var instance = new finnhub.SymbolChange();
