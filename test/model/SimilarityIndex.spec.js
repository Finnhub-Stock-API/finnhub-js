...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new finnhub.SimilarityIndex();
  });
  ...
  describe('SimilarityIndex', function() {
    it('should create an instance of SimilarityIndex', function() {
      // uncomment below and update the code to test SimilarityIndex
      //var instane = new finnhub.SimilarityIndex();
      //expect(instance).to.be.a(finnhub.SimilarityIndex);
    });
