...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new finnhub.MutualFundHoldingsData();
  });
  ...
  describe('MutualFundHoldingsData', function() {
    it('should create an instance of MutualFundHoldingsData', function() {
      // uncomment below and update the code to test MutualFundHoldingsData
      //var instane = new finnhub.MutualFundHoldingsData();
      //expect(instance).to.be.a(finnhub.MutualFundHoldingsData);
    });

    it('should have the property symbol (base name: "symbol")', function() {
      // uncomment below and update the code to test the property symbol
      //var instance = new finnhub.MutualFundHoldingsData();
