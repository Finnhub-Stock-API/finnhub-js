...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new finnhub.ETFsProfile();
  });
  ...
  describe('ETFsProfile', function() {
    it('should create an instance of ETFsProfile', function() {
      // uncomment below and update the code to test ETFsProfile
      //var instane = new finnhub.ETFsProfile();
      //expect(instance).to.be.a(finnhub.ETFsProfile);
    });
